...
import {View, Dimensions, FlatList, StyleSheet, ActivityIndicator} from 'react-native';
...
@observer
export default class MovieGridList extends Component<MovieGridListInterface> {
  // state
  state = {loading: false};
  itemWidth;
  itemHeight;
